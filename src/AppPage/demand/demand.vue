<template lang="html">
  <div>
    <app-scroolhead>
      ...
      <span slot="right-part" class="app-icon" @click="share">
...
import appScroolhead from 'src/components/appScrollhead.vue';
...
export default {
    ...
    methods: {
        ...
        submit() {
          ...
          if(maximum_area){
            ...
            postDemand(data).then(res => {
                ...
                this.$router.push('/appDemandSuccess');
            }).catch(err => {
        ...
        share(){
          setupWebViewJavascriptBridge(function(bridge) {
            bridge.callHandler('shareDemand', "需求定制" , function (data) {}) ;
          });
        }
    }
}
